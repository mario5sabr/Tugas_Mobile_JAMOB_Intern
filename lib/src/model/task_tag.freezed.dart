...
abstract class $TaskTagCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: "tag") String? tag, @ColorSerialiser() Color color});
}
...
class _$_TaskTag with DiagnosticableTreeMixin implements _TaskTag {
  _$_TaskTag(
      ...
      @ColorSerialiser() this.color = ColorSerialiser.defaultColor});
...
abstract class _TaskTag implements TaskTag {
  factory _TaskTag(
      ...
      @ColorSerialiser() final Color color}) = _$_TaskTag;
