...
class _$_Task with DiagnosticableTreeMixin implements _Task {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Task(title: $title, dueDateTime: $dueDateTime, description: $description, imageUrl: $imageUrl, taskTags: $taskTags, taskRelate: $taskRelate)';
  }
...
abstract class _Task implements Task {
  factory _Task(
      ...
      final String? imageUrl,
      final List<TaskTag>? taskTags,
      final TaskRelate? taskRelate}) = _$_Task;
